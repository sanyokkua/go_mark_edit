...
`FR-FT-033`). Go refuses stale *commands*; the acknowledgement race is frontend-only by construction,
...
1. **The 40-document scale is untested.** Every "40" elsewhere in the tree is the *cap*, not a switch
