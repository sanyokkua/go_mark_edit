...
Owner decisions that restore synchronized scrolling between the editor and the preview. Features 001–002 intended it (feature 002 deferred it as `#scroll-sync-by-heading`), and it was lost when the earlier specifications were generated.
