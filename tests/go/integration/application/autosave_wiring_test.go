...
type failingAutosaveSettingsRepository struct{}

func (failingAutosaveSettingsRepository) GetAppearance(context.Context) (apperr.AppearanceSettings, error) {
	return apperr.AppearanceSettings{}, errors.New("settings unavailable")
}
func (failingAutosaveSettingsRepository) GetMarkdown(context.Context) (apperr.MarkdownSettings, error) {
	return apperr.MarkdownSettings{}, errors.New("settings unavailable")
}
func (failingAutosaveSettingsRepository) GetContentPrivacy(context.Context) (apperr.ContentPrivacySettings, error) {
	return apperr.ContentPrivacySettings{}, errors.New("settings unavailable")
}
func (failingAutosaveSettingsRepository) GetEditor(context.Context) (apperr.EditorSettings, error) {
	return apperr.EditorSettings{}, errors.New("settings unavailable")
}
func (failingAutosaveSettingsRepository) GetFile(context.Context) (apperr.FileSettings, error) {
	return apperr.FileSettings{}, errors.New("settings unavailable")
}
func (failingAutosaveSettingsRepository) UpdateAppearance(context.Context, apperr.AppearanceSettings) error {
	return nil
}
func (failingAutosaveSettingsRepository) ResetAppearance(context.Context) error { return nil }
func (failingAutosaveSettingsRepository) UpdateMarkdown(context.Context, apperr.MarkdownSettings) error {
	return nil
}
func (failingAutosaveSettingsRepository) UpdateContentPrivacy(context.Context, apperr.ContentPrivacySettings) error {
	return nil
}
func (failingAutosaveSettingsRepository) UpdateEditor(context.Context, apperr.EditorSettings) error {
	return nil
}
func (failingAutosaveSettingsRepository) UpdateFile(context.Context, apperr.FileSettings) error {
	return nil
}
