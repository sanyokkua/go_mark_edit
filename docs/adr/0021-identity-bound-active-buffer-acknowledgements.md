...
- Spec clauses: `specification/02_Architecture/02_BACKEND_GO.md#application-model`,
  ...
  `specification/07_Phases/PHASE_02_FILE_IO_TABS.md#state-and-transition-model`,
  `specification/07_Phases/PHASE_02_FILE_IO_TABS.md#cross-phase-contracts`
- Stories: STORY-036, STORY-038, STORY-039, STORY-041, STORY-043
