...
| P0-4 | With both open, change the theme in instance A | A changes. **B does not** until relaunched. This is expected (`11_SETTINGS.md#persistence`) — confirm it rather than filing it. |
