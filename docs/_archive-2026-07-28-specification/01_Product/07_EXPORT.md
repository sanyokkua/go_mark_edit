...
So `afterprint` is treated as _completion regardless of outcome_: unmount the print root, release the
...
or explicit page breaks. (Repeated table headers _are_ supported — see the print stylesheet; the
