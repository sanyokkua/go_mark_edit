...
**Revision:** 2 (fact-checked and extended), 7 September 2026. Revision 1 is preserved unchanged as
[audit-revision-1-unverified.md](2026-09-07-project-health-evidence/audit-revision-1-unverified.md).
...
spec drift) · §6 Refactoring scope for `/speckit-specify` (epics A–F, non-goals, owner decisions D1–D10, sequence) ·
...
Revision 1 was produced by a previous agent session. This revision:
...
1. Capture the baseline (this commit, gate results, defect list) and settle D1–D10 in ADRs.
2. Epic A regressions and fixes together with RF-C1 (they share the owner), then RF-A1/A10/A11 as the first consumers
   of the new Popup (Epic B starts with the popup family because it is where the owner's defects are).
...
Acceptance is not "fewer lines". It is: the eight defects cannot recur, one common change reaches every consumer, the
