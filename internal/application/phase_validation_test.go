...
func TestRepositoryPhaseMigrationIsCompleteAndTruthful(t *testing.T) {
	...
	t.Run("Phase 01 reports the exact current blocker set", func(t *testing.T) {
		...
		expectedBlockers := []string{
			...
			"phase-complete-check: PH01-R04 is owned only by incomplete stories: STORY-022 (draft)",
			"phase-complete-check: PH01-R06 is owned only by incomplete stories: STORY-022 (draft)",
			"phase-complete-check: PH01-R07 is owned only by incomplete stories: STORY-021 (ready)",
			"phase-complete-check: PH01-R09 is owned only by incomplete stories: STORY-023 (draft)",
			"phase-complete-check: PH01-R10 is owned only by incomplete stories: STORY-023 (draft)",
			"phase-complete-check: PH01-R15 has no story acceptance-criterion coverage",
			"phase-complete-check: PH01-T03 transition lacks done-story AC/test evidence for PH01-R04, PH01-R06, PH01-R07",
			"phase-complete-check: PH01-T04 transition lacks done-story AC/test evidence for PH01-R07",
			"phase-complete-check: PH01-T06 transition lacks done-story AC/test evidence for PH01-R09, PH01-R10",
			"phase-complete-check: PH01-T07 transition lacks done-story AC/test evidence for PH01-R06",
			"phase-complete-check: PH01-C02 contract lacks done-story AC/test evidence for PH01-R04, PH01-R07",
			"phase-complete-check: PH01-C03 contract lacks done-story AC/test evidence for PH01-R09, PH01-R10",
			"phase-complete-check: PH01-C06 contract lacks done-story AC/test evidence for PH01-R06",
			"phase-complete-check: PH01-E02 exit evidence lacks done-story AC/test coverage for PH01-R04, PH01-R06, PH01-R07",
			"phase-complete-check: PH01-E04 exit evidence lacks done-story AC/test coverage for PH01-R09, PH01-R10",
			"phase-complete-check: PH01-E06 exit evidence lacks done-story AC/test coverage for PH01-R04, PH01-R06, PH01-R07",
