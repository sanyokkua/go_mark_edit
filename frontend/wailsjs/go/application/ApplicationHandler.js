...
export function AuthorizeQuit(arg1) {
  return window['go']['application']['ApplicationHandler']['AuthorizeQuit'](arg1);
}

export function CancelQuit(arg1) {
  return window['go']['application']['ApplicationHandler']['CancelQuit'](arg1);
}
