...
import type { LegacyNotification, NotificationNotice, NotificationTone } from './notificationTypes';
...
const NotificationBanner: React.FC<NotificationBannerProps> = ({ notification }): React.JSX.Element => {
