...
const iconShapes: Record<IconName, React.JSX.Element> = {
    ...
    bold: <path d="M4 2.5h3.7a2.5 2.5 0 0 1 .5 4.95H4m4.2 0A2.55 2.55 0 0 1 8 12.5H4v-10" />,
    'bullet-list': (
        <>
    ...
    modified: <circle cx="7.5" cy="7.5" r="2.3" fill="currentColor" stroke="none" />,
    'numbered-list': (
        <>
            <path d="M5.5 4h7M5.5 7.5h7M5.5 11h7" />
    ...
    preview: <path d="M1.8 7.5s2-3.3 5.7-3.3 5.7 3.3 5.7 3.3-2 3.3-5.7 3.3-5.7-3.3-5.7-3.3Z" />,
    quote: (
