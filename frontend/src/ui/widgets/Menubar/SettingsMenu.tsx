...
function settingsAccelerator(): string {
    ...
    return binding === undefined ? '' : formatShortcut(binding, currentPlatform());
}
...
const CompactSettingsContent: React.FC<CompactSettingsContentProps> = ({
    ...
    const availabilityOf = (id: ActionId): string => getAction(id).availability.kind;
...
const SettingsMenu: React.FC<SettingsMenuProps> = ({
    ...
    const dispatchSettingsAction = (actionId: ActionId, invoke: () => void): void => {
