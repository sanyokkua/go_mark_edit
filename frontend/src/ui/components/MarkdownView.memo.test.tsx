 ...
 *
 * T194. `PreviewPane` renders `MarkdownView`, and `EditorView` hands the pane an
 ...
 * cost.
 */
// Proves: FR-FT-005 (partial — that live preview does not re-run the Markdown
// pipeline when a parent re-renders without changing the document.)
it('T194 does not re-parse the document when a parent re-renders with the same source', () => {
...
// Proves: FR-FT-005 (partial — that a changed document still re-renders.)
it('T194 re-parses when the source actually changes', () => {
