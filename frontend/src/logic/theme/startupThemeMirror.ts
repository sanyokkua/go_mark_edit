import { normalizeAppearance, normalizeTheme, type AppearanceChoice, type Theme } from './theme';
...
export function writeStartupThemeMirror(storage: Storage, mirror: StartupThemeMirror): void {
    storage.setItem(storageKey, JSON.stringify({ version: startupThemeMirrorVersion, ...mirror }));
}
