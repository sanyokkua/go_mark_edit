...
export function resolveAppearance(choice: AppearanceChoice, prefersDark: () => boolean): ResolvedAppearance {
...
export function applyThemeToRoot(state: ThemeState, documentRef: Document): void {
