...
export type LifecycleCaptureProvider<TContent, TView, TActivationToken> = () =>
    LifecycleCapture<TContent, TView, TActivationToken> | Promise<LifecycleCapture<TContent, TView, TActivationToken>>;
...
export type LifecycleBarrierErrorCode = 'document-mismatch' | 'activation-mismatch';
...
export function createLifecycleBarrier<TContent = string, TView = unknown, TActivationToken = unknown>(
