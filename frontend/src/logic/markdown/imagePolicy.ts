...
export type ImagePlaceholderReason =
    'empty' | 'scheme' | 'malformed' | 'untitled-document' | 'absolute-path' | 'outside-document-folder';
...
export function classifyImageSource(source: string, documentPath?: string): ImageSource {
