...
export default {
    ...
    overrides: [
        ...
        {
            files: ['src/ui/components/**/*.module.css', 'src/ui/primitives/**/*.module.css'],
            rules: { 'selector-disallowed-list': null },
        },
        {
            files: ['src/ui/components/Popup/Popup.module.css', 'src/ui/components/ModalShell/ModalShell.module.css'],
            rules: {
                'declaration-property-value-disallowed-list': {
                    '/.*/': [colourLiteral],
                },
