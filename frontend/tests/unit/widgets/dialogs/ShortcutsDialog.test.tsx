...
import ShortcutsDialog from '../../../../src/ui/widgets/dialogs/ShortcutsDialog';

it('renders the complete registry-derived shortcuts catalogue', () => {
...
it('renders registry scope and localized deferred availability metadata', () => {
    ...
    expect(commandPalette).toHaveTextContent('This action is not available in this slice.');
