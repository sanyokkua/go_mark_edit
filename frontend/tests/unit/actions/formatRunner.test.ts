import type { DocumentCommandAPI, DocumentCommandResult } from '../../../src/logic/hooks/useDocumentCommands';
import { runFormatAction, type MarkdownMarkerPreferences } from '../../../src/logic/format/formatting';
...
it('runs every registered formatting action through one command runner', () => {
    const replaceRange = jest.fn<DocumentCommandResult<void>, Parameters<DocumentCommandAPI['replaceRange']>>(() => ({
        status: 'available',
        value: undefined,
    }));
