...
it('traps Tab and Shift+Tab inside the dialog', () => {
    render(
        <ModalShell dismiss="none" onRequestClose={jest.fn()} open title="Focus dialog">
...
it('uses Escape and backdrop dismissal only when their policy allows it', () => {
    ...
    const { rerender } = render(
        <ModalShell dismiss="escape" onRequestClose={onRequestClose} open title="Dismiss dialog">
            <p>Body</p>
        </ModalShell>,
    );
    ...
    rerender(
        <ModalShell dismiss="none" onRequestClose={onRequestClose} open title="Dismiss dialog">
            <p>Body</p>
        </ModalShell>,
    );
    fireEvent.keyDown(document, { key: 'Escape' });
...
it('restores focus to the opener when the shell closes', () => {
    ...
    opener.focus();
    const { rerender } = render(
        <ModalShell dismiss="escape" onRequestClose={jest.fn()} open title="Restoring dialog">
            <p>Body</p>
        </ModalShell>,
    );

    rerender(
        <ModalShell dismiss="escape" onRequestClose={jest.fn()} open={false} title="Restoring dialog">
            <p>Body</p>
        </ModalShell>,
    );
