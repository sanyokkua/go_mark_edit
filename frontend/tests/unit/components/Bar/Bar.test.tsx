...
import Bar from '../../../../src/ui/components/Bar/Bar';

it('renders leading, main and trailing slots in one labelled bar', () => {
  render(
    <Bar
      ariaLabel="Test bar"
...
it('relocates measured main content into an overflow Popup', () => {
