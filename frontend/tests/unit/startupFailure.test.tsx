...
it('names a failed settings step with its safe category and offers both actions', () => {
    ...
    expect(document.body).not.toHaveTextContent(/\/Users\/|[A-Z]:\\|stack trace|raw error/i);
});
...
it('names a timed-out bridge step and offers only Quit', () => {
    ...
    expect(screen.getByText('Bridge did not answer within 10 seconds')).toBeInTheDocument();
