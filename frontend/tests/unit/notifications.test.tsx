...
import Notifications, { type NotificationNotice } from '../../src/ui/components/Notifications';

afterEach((): void => {
    jest.useRealTimers();
});

function notice(overrides: Partial<NotificationNotice> = {}): NotificationNotice {
    return {
        id: 1,
        kind: 'warning',
