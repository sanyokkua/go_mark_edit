...
it('offers only the localized remediation label and keeps toasts above dialogs', () => {
    ...
    expect(readFileSync(resolve(process.cwd(), 'src/ui/primitives/Toast.module.css'), 'utf8')).toContain(
        'z-index: var(--z-toast)',
    );
    expect(readFileSync(resolve(process.cwd(), 'src/ui/primitives/Toast.module.css'), 'utf8')).toMatch(
