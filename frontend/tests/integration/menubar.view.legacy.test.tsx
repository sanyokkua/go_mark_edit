...
it('renders synchronized pane toggles without an unlisted view-cycle shortcut', (): void => {
    ...
    expect(screen.getByRole('menuitemcheckbox', { name: 'Show Editor' })).toHaveAttribute('data-state', 'checked');
    expect(screen.getByRole('menuitemcheckbox', { name: 'Show Preview' })).toHaveAttribute('data-state', 'unchecked');
    expect(screen.getByRole('menuitemcheckbox', { name: 'Show Editor' })).toHaveAttribute('data-disabled');
...
it('routes legacy editor and preview view toggles through the dispatcher', async () => {
    ...
    fireEvent.click(screen.getByRole('menuitemcheckbox', { name: 'Show Editor' }));
    fireEvent.keyDown(screen.getByRole('button', { name: 'View' }), {
        key: 'ArrowDown',
    });
    fireEvent.click(screen.getByRole('menuitemcheckbox', { name: 'Show Preview' }));
