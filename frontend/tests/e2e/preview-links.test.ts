...
test('case 1 keeps preview link activation in the app session', async ({ app }) => {
    ...
    await expectOneAutoDismissingWarning(page, outsideHref, 'outside the document folder');
    ...
    await expectOneAutoDismissingWarning(page, './next.md', 'Relative links need a document folder');
